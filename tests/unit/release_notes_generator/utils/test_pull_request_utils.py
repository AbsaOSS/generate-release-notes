    ...
    class MockRequester:
        ...
        def graphql_query(self, query, headers):
            ...
            return headers, {
                "data": {
                    "repository": {
                        "pullRequest": {"closingIssuesReferences": {"nodes": [{"number": 11}, {"number": 22}]}}
                    }
                }
            }
...
def test_get_issues_for_pr_empty_nodes(monkeypatch):
    ...
    class MockRequester:
        def graphql_query(self, query, headers):
            return headers, {"data": {"repository": {"pullRequest": {"closingIssuesReferences": {"nodes": []}}}}}
...
def test_get_issues_for_pr_caching(monkeypatch):
    ...
    class MockRequester:
        def graphql_query(self, query, headers):
            calls["count"] += 1
            return headers, {
                "data": {"repository": {"pullRequest": {"closingIssuesReferences": {"nodes": [{"number": 9}]}}}}
            }
...
def test_get_issues_for_pr_different_numbers_not_cached(monkeypatch):
    ...
    class MockRequester:
        def graphql_query(self, query, headers):
            ...
            return headers, {
                "data": {"repository": {"pullRequest": {"closingIssuesReferences": {"nodes": [{"number": pull_num}]}}}}
            }
